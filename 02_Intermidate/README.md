**21-Decorators** : Decorators allow you to modify the behaviour of functions or classes. They provide a clean and efficient way to add functionality to existing code without modifying it directly. 
